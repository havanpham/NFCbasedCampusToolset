...
public class Calendar extends Activity {
		...
		protected void onCreate(Bundle savedInstanceState) {
			...
			calIntent.putExtra(CalendarContract.EXTRA_EVENT_BEGIN_TIME, begin.getTimeInMillis());
			calIntent.putExtra(CalendarContract.EXTRA_EVENT_END_TIME, end.getTimeInMillis());
