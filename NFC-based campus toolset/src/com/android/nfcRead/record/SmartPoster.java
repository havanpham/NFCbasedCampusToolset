 ...
 */
package com.android.nfcRead.record;
...
import com.android.nfcRead.NdefMessageParser;
...
public class SmartPoster implements ParsedNdefRecord {
    ...
    private static NdefRecord getByType(byte[] type, NdefRecord[] records) {
        for (NdefRecord record : records) {
        	Log.d("action",  new String(record.getType()));
        	System.out.println("action: "+ new String(record.getType()));
    ...
    private static RecommendedAction parseRecommendedAction(NdefRecord[] records) {
        ...
        Log.e("action value", String.valueOf((char)action));
